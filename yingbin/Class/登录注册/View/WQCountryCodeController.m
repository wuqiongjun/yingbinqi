...
@interface WQCountryCodeController () <UITableViewDataSource,UITableViewDelegate,UISearchResultsUpdating> {
...
@implementation WQCountryCodeController

#pragma mark - system
- (void)viewDidLoad {
    [super viewDidLoad];
    self.view.backgroundColor = [UIColor whiteColor];
    self.navigationItem.title = NSLocalizedString(@"选择国家和地区",nil);
...
- (void)creatSubviews{
    ...
    _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, self.view.bounds.size.width, self.view.bounds.size.height - k_Height_SafetyArea) style:UITableViewStylePlain];
    ...
    _tableView.sectionIndexTrackingBackgroundColor = KColor(0, 125, 125, 1);//修改右边索引点击时候的背景色
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.detailTextLabel.textColor = KColor(0, 125, 125, 1);

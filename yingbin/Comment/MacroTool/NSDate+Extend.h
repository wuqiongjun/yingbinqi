...
#define     KK_READONLY_ASSIGN         @property (nonatomic, assign, readonly)
@interface NSDate (Extend)

// 获取当前的时间☟
KK_READONLY_ASSIGN NSInteger year;
KK_READONLY_ASSIGN NSInteger month;
KK_READONLY_ASSIGN NSInteger day;
KK_READONLY_ASSIGN NSInteger hour;
KK_READONLY_ASSIGN NSInteger minute;
KK_READONLY_ASSIGN NSInteger second;
KK_READONLY_ASSIGN NSInteger weekday;
...
/** 
 ...
 NSInteger timestamp = [NSDate timestampFromTimeString:timeString formatter:k_yyyyMMddHHmm];
 */
...
/**
 ...
 如：获取2天后的时间 [date backward:2 unitType:NSCalendarUnitDay];
 */
+ (NSDate *)backward:(NSInteger)backwardN date:(NSDate *)date unitType:(NSCalendarUnit)unit;
@end

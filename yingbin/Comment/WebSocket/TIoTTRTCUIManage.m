...
//    [HXYNotice postHeartBeat:devIds];
    [[NSNotificationCenter defaultCenter] postNotificationName:HeartBeatNoti object:devIds];
//
//    [HXYNotice addActivePushPost:devIds];
    [[NSNotificationCenter defaultCenter] postNotificationName:addActivePush object:devIds];
...
- (void)getTRTCDeviceData:(NSString *)productID devices:(NSArray *)devices {
    ...
    NSArray<DeviceViewModel *> *devicelist = [NSArray yy_modelArrayWithClass:DeviceViewModel.class json:devices];
    for (DeviceViewModel * device in devicelist) {
